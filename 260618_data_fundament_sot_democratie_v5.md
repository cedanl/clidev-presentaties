...
<!-- CONTACT (Slide3.PNG) -->
<div class="np-bg" style="background-image: url(/npuls/powerpoint_slides/Slide3.PNG);"></div>
<div class="fill" style="padding: 1.5rem 3rem;">
<p class="eyebrow">Contact</p>
<h1 style="font-size: 2.2rem; margin-bottom: 1.6rem;">Meer weten?</h1>
<div style="display: flex; flex-direction: column; gap: 0.9rem; font-size: 1rem;">
<div style="display: flex; align-items: center; gap: 0.9rem;"><span style="font-size: 1.4rem;">✉</span><div><div style="font-weight: 600; color: var(--np-ink);">Corneel den Hartogh</div><a href="mailto:corneel.denhartogh@surf.nl" style="color: var(--np-blue); font-size: 0.92rem;">corneel.denhartogh@surf.nl</a></div></div>
<div style="display: flex; align-items: center; gap: 0.9rem;"><span style="font-size: 1.4rem;">📞</span><div style="font-size: 0.92rem; color: var(--np-dark-gray);">06 1999 9817</div></div>
<div style="display: flex; align-items: center; gap: 0.9rem;"><span style="font-size: 1.4rem;">✉</span><div><div style="font-weight: 600; color: var(--np-ink);">CEDA</div><a href="mailto:ceda@surf.nl" style="color: var(--np-blue); font-size: 0.92rem;">ceda@surf.nl</a></div></div>
</div>
<div class="np-bottomline" style="margin-top: 1.2rem; font-size: 0.84rem;">CEDA — Centre of Educational Data Analytics &nbsp;·&nbsp; <strong>Npuls</strong></div>
</div>
