...
<div style="margin-left: 42%; height: 100%; display: flex; flex-direction: column; justify-content: center; padding-right: 3rem;">
  ...
  <div style="display: flex; flex-direction: column; gap: 0.6rem;">
    <div style="display: flex; align-items: flex-start; gap: 0.8rem;">
      ...
      <div><strong>Fundament</strong><div style="display: flex; flex-direction: column; gap: 0.15rem; margin-top: 0.3rem; padding-left: 0.5rem; border-left: 2px solid var(--np-blue);"><span class="muted" style="font-size: 0.78rem;">↳ Governance / Regie</span><span class="muted" style="font-size: 0.78rem;">↳ Data</span><span class="muted" style="font-size: 0.78rem;">↳ Machine Learning</span></div></div>
    </div>
...
<div class="flex items-center justify-center h-full">
  <div style="text-align: center;">
    ...
    <h1 style="color: #FFFFFF !important; font-size: 3rem;">Analytics Portal</h1>
...
<div style="border-left: 3px solid var(--np-orange); padding: 0.5rem 0.8rem; background: #FEF9F5; border-radius: 0 6px 6px 0; margin: 0.6rem 0; font-style: italic; font-size: 0.84rem; color: var(--np-dark-gray); line-height: 1.6;">
  "Mijn klas presteert minder goed dan vorig jaar. Ik vermoed dat het te maken heeft met verminderde aanwezigheid — wat zegt de data?"
</div>

**Agentic Portal** beantwoordt dit interactief, toegankelijk, zonder BI-kennis.

<div style="margin-top: 0.6rem; padding: 0.45rem 0.7rem; border: 1.5px solid var(--np-orange); border-radius: 6px; background: #FFF3ED; font-size: 0.8rem; color: var(--np-dark-gray);">
  <strong style="color: var(--np-orange);">⚠ Let op</strong> — Veilig en verantwoorde GenAI eist meer van je data- en autorisatie modellen.
</div>
...
<!-- ONDERWIJSDATA-CHAT DEMO — video slide, lokale mp4, lichte achtergrond -->
<div style="position: absolute; inset: 0; background: #f0f4f8; z-index: 0;"></div>
<div style="position: absolute; top: 0; left: 0; right: 0; z-index: 5; padding: 0.9rem 2rem 0; pointer-events: none;">
  <h1 style="font-size: 1.7rem; margin: 0; color: var(--np-orange);">onderwijsdata-chat — demo</h1>
  <p style="font-size: 0.78rem; color: var(--np-mid-gray); margin: 0.25rem 0 0;"><a href="https://github.com/cedanl/onderwijsdata-chat" style="color: var(--np-blue);">cedanl/onderwijsdata-chat</a></p>
</div>
<video
  src="/shots/onderwijsdata-chat.mp4"
  style="position: absolute; top: 96px; left: 2rem; right: 2rem; bottom: 1rem; width: calc(100% - 4rem); height: calc(100% - 106px); object-fit: contain; z-index: 10; display: block; background: #f0f4f8; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.12);"
  controls
  loop>
</video>
...
<h1 style="font-size: 2rem; margin-bottom: 1rem;">Meer weten?</h1>
<div class="np-grid-3" style="align-items: stretch; gap: 0.9rem;">
<div class="np-card accent-blue"><span class="np-badge blue">Nieuwsbrief</span><h3 style="margin-top: 0.5rem; font-size: 0.95rem;">Maandelijks updates</h3><p style="font-size: 0.82rem; color: var(--np-dark-gray); line-height: 1.55; margin: 0.3rem 0 0.6rem;">Op de hoogte blijven van CEDA-ontwikkelingen, tools en onderzoek.</p><a href="mailto:ceda@surf.nl" style="color: var(--np-blue); font-size: 0.84rem; font-weight: 600;">ceda@surf.nl</a></div>
<div class="np-card accent-orange"><span class="np-badge orange">Samenwijzer / SkillsRadar</span><h3 style="margin-top: 0.5rem; font-size: 0.95rem;">Meedoen aan Samenwijzer of SkillsRadar?</h3><p style="font-size: 0.82rem; color: var(--np-dark-gray); line-height: 1.55; margin: 0.3rem 0 0.6rem;">Tools testen of inzichten ophalen voor je instelling?</p><a href="mailto:ceda@surf.nl" style="color: var(--np-blue); font-size: 0.84rem; font-weight: 600;">ceda@surf.nl</a></div>
<div class="np-card accent-green"><span class="np-badge green">Sparren</span><h3 style="margin-top: 0.5rem; font-size: 0.95rem;">CEDA &amp; behoefte instelling</h3><p style="font-size: 0.82rem; color: var(--np-dark-gray); line-height: 1.55; margin: 0.3rem 0 0.6rem;">Corneel den Hartogh — Projectleider CEDA</p><a href="mailto:corneel.denhartogh@surf.nl" style="color: var(--np-blue); font-size: 0.84rem; font-weight: 600;">corneel.denhartogh@surf.nl</a><br/><span style="font-size: 0.82rem; color: var(--np-dark-gray);">06 1999 9817</span></div>
</div>
<div class="np-bottomline" style="margin-top: 0.9rem; font-size: 0.84rem;">CEDA — Centre of Educational Data Analytics &nbsp;·&nbsp; <strong>Npuls</strong></div>
</div>
